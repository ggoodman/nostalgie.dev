...
description: "Lean to build your first \"Hello World\" project with Nostalgie."
slug: "getting-started"
category: "tutorial"
---

import GettingStarted from './GettingStarted/getting_started.png'
...
Your app will now be started and can be seen at [loalhost:8080](http://localhost:8080). You should see something like this:

<img alt="Screenshot of the default Nostalgie template" className="block w-96 max-w-full mx-auto rounded-lg" src={GettingStarted} />
